              ...
              <tr v-for="user in users" :key="user.email.S">
                ...
                <td>
                  <span v-if="user.provider && user.provider.S">
                  	<h5><span v-if="user.provider.S == 'jwt'" class="badge badge-info">Мэйл, нууц үг</span></h5>
                  	<h5><span v-if="user.provider.S == 'facebook'" class="badge badge-warning">Фэйсбүүк</span></h5>
                  </span>
                </td>
                <td>
